...
public class TableAccessControlManager {
    ...
    public static class AccessControlContext {
        ...
        private boolean CRUDPermission = false;

        public boolean isCRUDPermission() {
            return CRUDPermission;
        }

        public void setCRUDPermission(boolean crudPermission) {
    ...
    public static class AccessControlVisitor extends BaseAlgebraVisitor<AccessControlContext, Expr> {
        private TajoConf tajoConf = new TajoConf();

        public void verifyAccessControl(AccessControlContext context, Expr expr) throws PlanningException {
            context.setCRUDPermission(tajoConf.getBoolean("tajo.proxy.crud.permission", false));
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(ctx.isCRUDPermission() + "," + ctx.isPermission() + "," + ctx.getErrorMessage());
