...
<%@ page import="org.apache.tajo.catalog.partition.*" %>
...
<%
  ...
  proxyClient.selectDatabase(selectedDatabase);

  TableDesc tableDesc = null;
  String selectedTable = request.getParameter("table");
  if(selectedTable != null && !selectedTable.trim().isEmpty()) {
    tableDesc = proxyClient.getTableDesc(selectedTable);
  } else {
    selectedTable = "";
  }

  //TODO filter with database
  Collection<String> tableNames = proxyClient.getTableList(selectedDatabase);
%>
      ...
      <td width="20%" valign="top">
        <div>
          ...
          <form action='catalogview.jsp' method='GET'>
            ...
            <%
            for (String databaseName : proxyClient.getAllDatabaseNames()) {
